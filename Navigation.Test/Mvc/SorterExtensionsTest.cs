...
namespace Navigation.Test.Mvc
{
	...
	public class SorterExtensionsTest
	{
		...
		public void SorterDefaultDescendingTest()
		{
			...
			Assert.AreEqual("<a data-include-current=\"true\" data-navigation=\"refresh\" href=\"/r0?sortExpression=a%20DESC\">link</a>", HtmlHelper.Sorter("link", "a").ToHtmlString());
		}
		...
		public void SorterAscendingTest()
		{
			...
			Assert.AreEqual("<a data-include-current=\"true\" data-navigation=\"refresh\" href=\"/r0?sortExpression=a\">link</a>", HtmlHelper.Sorter("link", "a").ToHtmlString());
		}
		...
		public void SorterSortExpressionTest()
		{
			...
			Assert.AreEqual("<a data-include-current=\"true\" data-navigation=\"refresh\" href=\"/r0?orderBy=a\">link</a>", HtmlHelper.Sorter("link", "a", "orderBy").ToHtmlString());
		}
		...
		{
			StateController.Navigate("d7", new NavigationData { { "sortExpression", "a DESC" } });
			Assert.AreEqual("<a data-include-current=\"true\" data-navigation=\"refresh\" href=\"/r0?sortExpression=a\" title=\"details\">link</a>", HtmlHelper.Sorter("link", "a", 
		...
		{
			StateController.Navigate("d7", new NavigationData { { "orderBy", "a DESC" } });
			Assert.AreEqual("<a data-include-current=\"true\" data-navigation=\"refresh\" href=\"/r0?orderBy=a\" title=\"details\">link</a>", HtmlHelper.Sorter("link", "a", "orderBy",
				new { title = "details" }).ToHtmlString());
		}
	}
}
