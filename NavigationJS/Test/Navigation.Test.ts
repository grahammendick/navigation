module Navigation.Test {
    ...
    QUnit.test('NavigatedCrossDialogTest', function (assert) {
        Navigation.StateController.navigate('d0');
        var link = Navigation.StateController.getNavigationLink('t0');
        Navigation.StateController.navigateLink(link);
    ...
    QUnit.test('CrumbDataAndDefaultsCustomTrailLinkTest', function (assert) {
        var link = Navigation.StateController.getNavigationLink('d0');
        Navigation.StateController.navigateLink(link);
        var data = { s: 1, t: '2' };
        link = Navigation.StateController.getNavigationLink('t0', data);
    ...
    QUnit.test('CrumbDataAndDefaultsCustomTrailRouteLinkTest', function (assert) {
        var link = Navigation.StateController.getNavigationLink('d3');
        Navigation.StateController.navigateLink(link);
        var data = { s: 1, t: '2' };
        link = Navigation.StateController.getNavigationLink('t0', data);
    ...
    QUnit.test('NavigateOverrideCrumbDefaultsCustomTrailLinkTest', function (assert) {
        var link = Navigation.StateController.getNavigationLink('d0');
        Navigation.StateController.navigateLink(link);
        var data = {};
        data['string'] = 'World';
    ...
    QUnit.test('NavigateOverrideCrumbDefaultsCustomTrailRouteLinkTest', function (assert) {
        var link = Navigation.StateController.getNavigationLink('d3');
        Navigation.StateController.navigateLink(link);
        var data = {};
        data['string'] = 'World';
    ...
    QUnit.test('OverrideCrumbDefaultsCustomTrailLinkTest', function (assert) {
        var link = Navigation.StateController.getNavigationLink('d0');
        Navigation.StateController.navigateLink(link);
        var data = {};
        link = Navigation.StateController.getNavigationLink('t0', data);
    ...
    QUnit.test('OverrideCrumbDefaultsCustomTrailRouteLinkTest', function (assert) {
        var link = Navigation.StateController.getNavigationLink('d3');
        Navigation.StateController.navigateLink(link);
        var data = {};
        link = Navigation.StateController.getNavigationLink('t0', data);
    ...
    QUnit.test('NavigateLinkDefaultsTest', function (assert) {
        Navigation.StateController.navigate('d0');
        var data = {};
        data['_bool'] = null;
        data['string'] = 'Hello';
    ...
    QUnit.test('NavigateLinkDefaultsRouteTest', function (assert) {
        Navigation.StateController.navigate('d3');
        var data = {};
        data['_bool'] = null;
        data['string'] = 'Hello';
    ...
    QUnit.test('NavigateLinkContextDefaultsTest', function (assert) {
        Navigation.StateController.navigate('d0');
        Navigation.StateController.navigate('t0');
        Navigation.StateController.navigate('t0');
    ...
    QUnit.test('NavigateLinkContextDefaultsRouteTest', function (assert) {
        Navigation.StateController.navigate('d3');
        Navigation.StateController.navigate('t0');
        Navigation.StateController.navigate('t0');
        Navigation.StateContext.data['emptyString'] = 1;
    ...
    QUnit.test('RefreshLinkDefaultsTest', function (assert) {
        Navigation.StateController.navigate('d0');
        Navigation.StateController.navigate('t0');
    ...
    QUnit.test('BackLinkDefaultsTest', function (assert) {
        Navigation.StateController.navigate('d0');
        Navigation.StateController.navigate('t0');
        Navigation.StateContext.data['_bool'] = null;
        Navigation.StateContext.data['string'] = 'Hello';
    ...
    QUnit.test('CrumbLinkDefaultsTest', function (assert) {
        Navigation.StateController.navigate('d0');
        Navigation.StateController.navigate('t0');
    ...
    QUnit.test('NavigateOverrideDefaultTypesLinkTest', function (assert) {
        var link = Navigation.StateController.getNavigationLink('d1');
        Navigation.StateController.navigateLink(link);
        var data = {};
        data['s1'] = true;
    ...
    QUnit.test('NavigateRefreshOverrideDefaultTypesLinkTest', function (assert) {
        var link = Navigation.StateController.getNavigationLink('d1');
        Navigation.StateController.navigateLink(link);
        var data = {};
        data['s1'] = true;
    ...
    QUnit.test('NavigateBackOverrideDefaultTypesLinkTest', function (assert) {
        var link = Navigation.StateController.getNavigationLink('d1');
        Navigation.StateController.navigateLink(link);
        var data = {};
        data['s1'] = true;
    ...
    QUnit.test('NavigateRefreshCurrentDataLinkTest', function (assert) {
        var link = Navigation.StateController.getNavigationLink('d0');
        Navigation.StateController.navigateLink(link);
        var data = {};
        data['s'] = 'Hello';
    ...
    QUnit.test('NavigateCurrentDataDefaultsLinkTest', function (assert) {
        var data = {};
        data['emptyString'] = 'Hello';
        data['number'] = 1;
        data['char'] = '6';
    ...
    QUnit.test('NavigateMissingRouteDataLinkTest', function (assert) {
    ...
    QUnit.test('NavigateRefreshMissingRouteDataLinkTest', function (assert) {
        var link = Navigation.StateController.getNavigationLink('d4');
        Navigation.StateController.navigateLink(link);
        link = Navigation.StateController.getNavigationLink('t0');
        Navigation.StateController.navigateLink(link);
