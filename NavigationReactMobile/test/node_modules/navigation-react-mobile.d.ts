...
/**
 * Holds the Shared Elements and their data
 */
...
/**
 * Identifies HTML Elements that can be shared between scenes when navigating
 */
export class SharedElement extends Component<SharedElementProps> { }

/**
 * Animates Shared Elements when navigating between Scenes
 */
