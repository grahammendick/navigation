...
class NavigationBar extends React.Component<any, any> {
  ...
  getScrollEdgeProps() {
    ...
    return {
      barTintColor:
        typeof barTintColor === "function" ? barTintColor(true) : barTintColor,
      largeBarTintColor:
        typeof barTintColor === "function" ? barTintColor(false) : barTintColor,
      titleColor:
        typeof titleColor === "function" ? titleColor(true) : titleColor,
      largeTitleColor:
        typeof titleColor === "function" ? titleColor(false) : titleColor,
      titleFontFamily:
        typeof titleFontFamily === "function"
      ...
      largeTitleFontFamily:
        typeof titleFontFamily === "function"
          ...
          : titleFontFamily,
      titleFontWeight:
        typeof titleFontWeight === "function"
      ...
      largeTitleFontWeight:
        typeof titleFontWeight === "function"
          ...
          : titleFontWeight,
      titleFontStyle:
        typeof titleFontStyle === "function"
          ? titleFontStyle(true)
          : titleFontStyle,
      largeTitleFontStyle:
        typeof titleFontStyle === "function"
          ...
          : titleFontStyle,
      titleFontSize:
        typeof titleFontSize === "function"
          ? titleFontSize(true)
          : titleFontSize,
      largeTitleFontSize:
        typeof titleFontSize === "function" ? titleFontSize(false) : null,
    };
  }
  render() {
    var {
    ...
    statusBar =
      (Platform.OS === "android" || !statusBar) && (statusBar || <StatusBar />);
    if (Platform.OS === "android" && hidden) return statusBar;
    if (bottomBar) return <BottomAppBar {...this.props} />;
    var collapsingBar =
      Platform.OS === "android" &&
    ...
    return (
      <>
        <NVNavigationBar
          ...
          barTintColor={
            !collapsingBar
              ? scrollEdgeProps.barTintColor
              : scrollEdgeProps.largeBarTintColor
          }
        >
          {Platform.OS === "ios" ? (
            !hidden && children
            ...
            >
              ...
              <NVToolbar
                ...
                {...scrollEdgeProps}
                barTintColor={
                  !collapsingBar ? scrollEdgeProps.barTintColor : null
                }
                style={{ height: 56 }}
              >
                {[
