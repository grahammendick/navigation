...
type NavigationStackProps = {underlayColor: string, title: (state: State, data: any) => string, crumbStyle: any, unmountStyle: any, hidesTabBar: any, sharedElement: any, backgroundColor: any, orientation: any, stackInvalidatedLink: string, renderScene: (state: State, data: any) => ReactNode, children: any};
...
const NavigationStack = ({underlayColor = '#000', title, crumbStyle: crumbStyleStack = () => null, unmountStyle: unmountStyleStack = () => null,
    ...
    orientation: orientationStack = () => null, stackInvalidatedLink, renderScene, children}: NavigationStackProps) => {
    ...
    const orientation = (state, ...rest) => sceneProps(state)?.orientation ? returnOrCall(sceneProps(state)?.orientation, ...rest) : orientationStack(state, ...rest);
    const getAnimation = () => {
