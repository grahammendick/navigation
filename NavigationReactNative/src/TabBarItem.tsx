...
const TabBarItem = ({
  ...
  return (
    <>
      <BackButton
        onPress={() => selected && backHandler.current.handleBack()}
      />
...
var NVTabBarItem = global.nativeFabricUIManager
  ? require("./TabBarItemNativeComponent").default
  : requireNativeComponent("NVTabBarItem");
