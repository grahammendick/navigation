...
export default ({activeTab, goToPage}) => (
  <View style={styles.footer}>
    <TouchableHighlight
      ...
      <View>
        ...
        <Text style={{color: activeTab === 0 ? '#1da1f2' : '#657786'}}>Timelines</Text>
      </View>
    </TouchableHighlight>
    <TouchableHighlight
      underlayColor="white"
      ...
      <View>
        ...
        <Text style={{color: activeTab === 1 ? '#1da1f2' : '#657786'}}>Notifications</Text>
      </View>
    </TouchableHighlight>
    <Animated.View />
  </View>
