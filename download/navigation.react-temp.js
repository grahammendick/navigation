...
var withStateNavigator = function (Link) { return function (props) { return (React.createElement(NavigationContext.Consumer, null, function (value) { return React.createElement(Link, __assign$1({ stateNavigator: value && value.stateNavigator, navigationContext: !!value }, props)); })); }; };
