/**
 * Navigation React v4.1.1
 * (c) Graham Mendick - http://grahammendick.github.io/navigation/
 * License: Apache-2.0
 */
var NavigationReact = (function (exports,navigation,React) {
    'use strict';
    ...
    var AsyncStateNavigator = /** @class */ (function (_super) {
        ...
        AsyncStateNavigator.prototype.navigateLink = function (url, historyAction, history, suspendNavigation, currentContext, defer) {
            var _this = this;
            ...
            if (!suspendNavigation)
                suspendNavigation = function (_stateContext, resumeNavigation) { return resumeNavigation(); };
        ...
        AsyncStateNavigator.prototype.suspendNavigation = function (asyncNavigator, resumeNavigation, defer) {
            ...
            this.navigationHandler.setState(function () { return ({ context: { oldState: oldState, state: state, data: data, asyncData: asyncData, nextState: null, nextData: {}, stateNavigator: asyncNavigator } }); }, function () {
    ...
    var FluentLink = function (props) {
        var htmlProps = LinkUtility.toHtmlProps(props);
        var _a = props.withContext, withContext = _a === void 0 ? false : _a, navigate = props.navigate, stateNavigator = props.stateNavigator;
        try {
    ...
    var FluentLink$1 = withStateNavigator(FluentLink);
    ...
    exports.FluentLink = FluentLink$1;
