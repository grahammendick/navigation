...
var Motion =  (function (_super) {
    ...
    function Motion(props, context) {
        ...
        var _a = _this.props, data = _a.data, enter = _a.enter, getKey = _a.getKey;
        var items = data.map(function (item) {
            var newItem = { key: getKey(item), data: item, progress: 1, tick: 0 };
...
var withStateNavigator = function (Component$$1) { return function (props) { return (React.createElement(navigationReact.NavigationContext.Consumer, null, function (_a) {
    var stateNavigator = _a.stateNavigator;
    return React.createElement(Component$$1, __assign({ stateNavigator: stateNavigator }, props));
})); }; };
...
var NavigationMotion =  (function (_super) {
    ...
    NavigationMotion.prototype.getScenes = function () {
        ...
        return crumbs.concat(nextCrumb).map(function (_a, index, crumbsAndNext) {
            ...
            return { key: index, state: state, data: data, url: url, crumbs: preCrumbs, nextState: postCrumb && postCrumb.state,
                nextData: postCrumb && postCrumb.data, scene: _this.state.scenes[index], mount: url === nextCrumb.url };
        });
    };
    ...
    NavigationMotion.prototype.render = function () {
        var _this = this;
        var _a = this.props, children = _a.children, duration = _a.duration, sharedElementMotion = _a.sharedElementMotion;
        ...
        var SceneMotion = Motion;
        return (stateContext.state &&
            React.createElement(SceneMotion, { data: this.getScenes(), getKey: function (_a) {
                    var key = _a.key;
                    return key;
                ...
                }, duration: duration }, function (tweenStyles) { return (tweenStyles.map(function (_a) {
                var _b = _a.data, key = _b.key, scene = _b.scene, state = _b.state, data = _b.data, url = _b.url, tweenStyle = _a.style;
    ...
    NavigationMotion.childContextTypes = {
        registerSharedElement: function () { return null; },
        unregisterSharedElement: function () { return null; }
    };
...
var SharedElementMotion =  (function (_super) {
    ...
    SharedElementMotion.prototype.render = function () {
        ...
        var ElementMotion = Motion;
        return (sharedElements.length !== 0 &&
            React.createElement(ElementMotion, { data: sharedElements, getKey: function (_a) {
                    var name = _a.name;
                    return name;
                }, enter: function (_a) {
