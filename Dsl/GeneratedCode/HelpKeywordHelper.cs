...
namespace Navigation.Designer
{
	...
	/// </remarks>
	public partial class NavigationLanguageHelpKeywordHelper : NavigationLanguageHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new NavigationLanguageHelpKeywordHelper.
		/// </summary>
		protected NavigationLanguageHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the NavigationLanguageHelpKeywordHelper.
		/// </summary>
		public static NavigationLanguageHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class NavigationLanguageHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new NavigationLanguageHelpKeywordHelperBase.
		/// </summary>
		protected NavigationLanguageHelpKeywordHelperBase()
			: base() { }
