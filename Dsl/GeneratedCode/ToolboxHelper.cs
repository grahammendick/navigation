...
namespace Navigation.Designer
{
	...
	/// </remarks>
	public partial class NavigationLanguageToolboxHelper : NavigationLanguageToolboxHelperBase 
	{
		/// <summary>
		/// Constructs a new NavigationLanguageToolboxHelper.
		/// </summary>
		public NavigationLanguageToolboxHelper(global::System.IServiceProvider serviceProvider)
	...
	public abstract class NavigationLanguageToolboxHelperBase
	{
		/// <summary>
		/// Toolbox item filter string used to identify NavigationLanguage toolbox items.  
		/// </summary>
		/// <remarks>
		...
		public static string DefaultToolboxTabName
		{
			get
			{
				return global::Navigation.Designer.NavigationLanguageDomainModel.SingletonResourceManager.GetString("Navigation DesignerToolboxTab", global::System.Globalization.CultureInfo.CurrentUICulture);
			}
		}
		...
		public virtual DslDesign::ModelingToolboxItem GetToolboxItem(string itemId, DslModeling::Store store)
		{
			...
			switch(itemId)
			{
				case "Navigation.Designer.StateToolboxItem":
					// Add State shape tool.
					result = new DslDesign::ModelingToolboxItem(
						"Navigation.Designer.StateToolboxItem", // Unique identifier (non-localized) for the toolbox item.
						...
						"Navigation.Designer.Navigation DesignerToolboxTab", // Unique identifier (non-localized) for the toolbox item tab.
						resourceManager.GetString("Navigation DesignerToolboxTab", resourceCulture), // Localized display name for the toolbox tab.
						...
						CreateElementToolPrototype(store, global::Navigation.Designer.State.DomainClassId), // ElementGroupPrototype (data object) representing model element on the toolbox.
						new global::System.ComponentModel.ToolboxItemFilterAttribute[] { // Collection of ToolboxItemFilterAttribute objects that determine visibility of the toolbox item.
						new global::System.ComponentModel.ToolboxItemFilterAttribute(ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require) 
						});
					break;
				case "Navigation.Designer.TransitionToolboxItem":

					// Add Transition connector tool.
					result = new DslDesign::ModelingToolboxItem(
						"Navigation.Designer.TransitionToolboxItem", // Unique identifier (non-localized) for the toolbox item.
		...
		protected DslModeling::Store ToolboxStore
		{
			...
			{ 
				if (toolboxStore==null)
				{
					...
					toolboxStore.LoadDomainModels(typeof(global::Navigation.Designer.NavigationLanguageDomainModel));
