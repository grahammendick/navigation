...
export class StateNavigator {
    ...
    setStateContext(state: State, data: any, url: string, asyncData: any, history: boolean, stateContext?: StateContext)
    /**
    ...
    getNavigateContinuation(oldUrl: string, state: State, data: any, url: string, historyAction: string, history: boolean): () => void;
    /**
     * Parses the url out into State and Navigation Data
     * @param url The url to parse
     */
    parseLink(url: string, includeCrumbTrail?): { state: State; data: any; };
    /**
