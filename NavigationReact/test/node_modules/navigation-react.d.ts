// Type definitions for NavigationReact 3.0
...
import { Component, AnchorHTMLAttributes, DetailedHTMLProps, MouseEvent } from 'react';
...
export var NavigationContext: any;
export class NavigationHandler extends Component<any> { }
