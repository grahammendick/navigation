...
import { Component, Context, Provider, Consumer, AnchorHTMLAttributes, DetailedHTMLProps, MouseEvent } from 'react';
 ...
 */
export var NavigationContext: Context<NavigationEvent<any, any>>;
 ...
 */
export interface RefreshLinkProps<NavigationInfo, Key> extends LinkProps {
    /**
 ...
 */
export interface NavigationLinkProps<NavigationInfo, StateKey> extends RefreshLinkProps<NavigationInfo, StateKey> {
    /**
