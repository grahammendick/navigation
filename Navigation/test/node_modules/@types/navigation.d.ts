...
export class State<Key extends string = string, Data extends object = any> implements StateInfo<Key> {
     ...
     */
    urlEncode(state: State<Key, Data>, key: string, val: string, queryString: boolean, index?: number): string;
    /**
     ...
     * @param queryString A value indicating the Url value's location
     */
    urlDecode(state: State<Key, Data>, key: string, val: string, queryString: boolean): string;
    /**
...
export class Crumb<Key extends string = string, Data extends object = any> {
     ...
     * crumb trail
     */
    constructor(data: Data, state: State<Key>, link: string, crumblessLink: string, last: boolean);
}
