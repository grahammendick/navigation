 ...
 */
export interface StateInfo<TKey extends string = string> {
    /**
     * Gets the unique key
     */
    key: TKey;
 ...
 */
export class State<TKey extends string = string> implements StateInfo<TKey> {
    /**
     * Gets the unique key
     */
    key: TKey;
     ...
     */
    urlEncode(state: State<TKey>, key: TKey, val: string, queryString: boolean, index?: number): string;
    /**
     ...
     * @param queryString A value indicating the Url value's location
     */
    urlDecode(state: State<TKey>, key: TKey, val: string, queryString: boolean): string;
    /**
     ...
     */
    truncateCrumbTrail(state: State<TKey>, data: any, crumbs: Crumb[]): Crumb[];
}
 ...
 */
export class StateContext<TKeys extends string = string> {
    /**
     * Gets the last State displayed before the current State
     */
    oldState: State<TKeys>;
    /**
 ...
 */
export interface FluentNavigator<TKeys extends string = string> {
    /**
     * Gets the current Url
     */
    url: string;
     ...
     */
    navigate(stateKey: TKeys, navigationData?: any): FluentNavigator<TKeys>;
    /**
     ...
     * @throws A mandatory route parameter has not been supplied a value
     */
    navigateBack(distance: number): FluentNavigator<TKeys>;
    /**
     ...
     * @throws A mandatory route parameter has not been supplied a value
     */
    refresh(navigationData?: any): FluentNavigator<TKeys>;
}
 ...
 * current State
 */
export class StateNavigator<TKeys extends string> {
    /**
     * Provides access to context sensitive navigation information
     */
    stateContext: StateContext<TKeys>;
    /**
     ...
     */
    constructor(stateInfos?: StateInfo<TKeys>[] | StateNavigator<TKeys>, historyManager?: HistoryManager);
    /**
     * Configures the StateNavigator
     * @param stateInfos A collection of State Infos or another State Navigator
     * @param historyManager The manager of the browser Url
     */
    configure(stateInfos: StateInfo<TKeys>[] | StateNavigator<TKeys>, historyManager?: HistoryManager): void;
    /**
     * Registers a before navigate event listener
     * @param handler The before navigate event listener
     */
    onBeforeNavigate(handler: (state: State<TKeys>, data: any, url: string, history: boolean, currentContext: StateContext<TKeys>) => boolean): void;
    /**
     * Unregisters a before navigate event listener
     * @param handler The before navigate event listener
     */
    offBeforeNavigate(handler: (state: State<TKeys>, data: any, url: string, history: boolean, currentContext: StateContext<TKeys>) => boolean): void;
    /**
     * Registers a navigate event listener
     * @param handler The navigate event listener
     */
    onNavigate(handler: (oldState: State<TKeys>, state: State<TKeys>, data: any, asyncData: any, stateContext: StateContext<TKeys>) => void): void;
    /**
     * Unregisters a navigate event listener
     * @param handler The navigate event listener
     */
    offNavigate(handler: (oldState: State<TKeys>, state: State<TKeys>, data: any, asyncData: any, stateContext: StateContext<TKeys>) => void): void;
    /**
     * Navigates to a State
     * @param stateKey The key of a State
     * @param navigationData The NavigationData to be passed to the next
     ...
     * @throws A mandatory route parameter has not been supplied a value
     */
    navigate(stateKey: TKeys, navigationData?: any, historyAction?: 'add' | 'replace' | 'none'): void;
    /**
     ...
     * NavigationData that cannot be converted to a String
     */
    getNavigationLink(stateKey: TKeys, navigationData?: any): string;
    /**
     ...
     */
    fluent(withContext?: boolean): FluentNavigator<TKeys>;
    /**
