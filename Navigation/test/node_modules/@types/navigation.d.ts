 ...
 */
export class State<Key extends string = string, NavigationData extends object = any> implements StateInfo<Key> {
    /**
     * Gets the unique key
     */
    key: Key;
     ...
     * Gets the default NavigationData for this State
     */
    defaults: Partial<NavigationData>;
    /**
     * Gets the default NavigationData Types for  this State
     */
    defaultTypes: any;
     ...
     */
    navigated: (data: NavigationData, asyncData: any) => void;
    /**
     ...
     * @param history A value indicating whether browser history was used
     */
    navigating: (data: NavigationData, url: string, navigate: (asyncData?: any) => void, history: boolean) => void;
    /**
     ...
     */
    urlEncode(state: State<Key, NavigationData>, key: string, val: string, queryString: boolean, index?: number): string;
    /**
     ...
     * @param queryString A value indicating the Url value's location
     */
    urlDecode(state: State<Key, NavigationData>, key: string, val: string, queryString: boolean): string;
    /**
     * Validates the NavigationData before navigating to the new State
     * @param data The new NavigationData
     * @returns Validation success indicator
     */
    validate(data: NavigationData): boolean;
    /**
     ...
     */
    truncateCrumbTrail(state: State<Key, NavigationData>, data: NavigationData, crumbs: Crumb[]): Crumb[];
}
 ...
 */
export class Crumb<Key extends string = string, NavigationData extends object = any> {
    /**
     ...
     * crumb trail
     */
    constructor(data: NavigationData, state: State<Key>, link: string, crumblessLink: string, last: boolean);
}
 ...
 */
export class StateContext<Key extends string = string, NavigationData extends object = any> {
    /**
     ...
     */
    state: State<Key, NavigationData>;
    /**
     ...
     * Gets the next crumb
     */
    nextCrumb: Crumb<Key, NavigationData>;
    /**
...
export interface FluentNavigator<
    NavigationInfo extends { [index: string]: null | object } = {},
    CurrentStateKey extends keyof NavigationInfo = string
>  {
    /**
     * Gets the current Url
     */
     ...
     * @throws A mandatory route parameter has not been supplied a value
     */
    refresh(navigationData?: null | NavigationInfo[CurrentStateKey]): FluentNavigator<NavigationInfo, CurrentStateKey>;
}
...
> {
     ...
     */
    stateContext: StateContext<CurrentStateKey & string, CurrentStateKey extends keyof NavigationInfo ? NavigationInfo[CurrentStateKey] : any>;
    /**
     ...
     */
    constructor(stateInfos?: StateInfo<keyof NavigationInfo & string>[] | StateNavigator<NavigationInfo>, historyManager?: HistoryManager);
    /**
     * Configures the StateNavigator
     * @param stateInfos A collection of State Infos or another State Navigator
     * @param historyManager The manager of the browser Url
     */
    configure(stateInfos: StateInfo<keyof NavigationInfo & string>[] | StateNavigator<NavigationInfo>, historyManager?: HistoryManager): void;
    /**
     ...
     * @throws A mandatory route parameter has not been supplied a value
     */
    refresh(navigationData?: null | NavigationInfo[CurrentStateKey], historyAction?: 'add' | 'replace' | 'none'): void;
    /**
     ...
     * @throws There is NavigationData that cannot be converted to a String
     */
    getRefreshLink(navigationData?: null | NavigationInfo[CurrentStateKey]): string;
    /**
    ...
    navigateLink(url: string, historyAction?: 'add' | 'replace' | 'none', history?: boolean,
        ...
        currentContext?: StateContext<CurrentStateKey & string, CurrentStateKey extends keyof NavigationInfo ? NavigationInfo[CurrentStateKey] : any>): void;
    /**
     ...
     */
    fluent<B extends boolean>(withContext?: B): FluentNavigator<NavigationInfo, B extends true ? CurrentStateKey : string>
    /**
