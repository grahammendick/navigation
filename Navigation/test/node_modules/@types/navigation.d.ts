 ...
 */
export interface FluentNavigator<NavigationInfo extends { [index: string]: null | object } = any, Key extends keyof NavigationInfo = string>  {
    /**
     * Gets the current Url
     */
    url: string;
...
export class StateNavigator<NavigationInfo extends { [index: string]: any } = any, Key extends keyof NavigationInfo = string> {
     ...
     */
    stateContext: StateContext<Key & string, NavigationInfo[Key] | any>;
    /**
    ...
    navigateLink(url: string, historyAction?: 'add' | 'replace' | 'none', history?: boolean,
        ...
        currentContext?: StateContext<Key & string, NavigationInfo[Key] | any>): void;
    /**
