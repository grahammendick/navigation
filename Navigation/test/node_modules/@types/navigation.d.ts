 ...
 */
export interface FluentNavigator<NavigationInfo extends { [index: string]: null | object } = {}, Key extends keyof NavigationInfo = string>  {
    /**
     * Gets the current Url
     */
    url: string;
 ...
 * current State
 */
export class StateNavigator<NavigationInfo extends { [index: string]: null | object } = {}, Key extends keyof NavigationInfo = string> {
    /**
     * Provides access to context sensitive navigation information
     */
    stateContext: StateContext<Key & string, Key extends keyof NavigationInfo ? NavigationInfo[Key] & object : any>;
    /**
     ...
     */
    states: { [Key in keyof NavigationInfo & string]: State<Key, NavigationInfo[Key] & object>; };
    /**
    ...
    navigateLink(url: string, historyAction?: 'add' | 'replace' | 'none', history?: boolean,
        ...
        currentContext?: StateContext<Key & string, Key extends keyof NavigationInfo ? NavigationInfo[Key] & object : any>): void;
    /**
