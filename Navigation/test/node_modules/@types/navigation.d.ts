 ...
 */
export class State<Key extends string = string> implements StateInfo<Key> {
    /**
     * Gets the unique key
     */
    key: Key;
     ...
     */
    urlEncode(state: State<Key>, key: string, val: string, queryString: boolean, index?: number): string;
    /**
     ...
     * @param queryString A value indicating the Url value's location
     */
    urlDecode(state: State<Key>, key: string, val: string, queryString: boolean): string;
    /**
     ...
     */
    truncateCrumbTrail(state: State<Key>, data: any, crumbs: Crumb[]): Crumb[];
}
 ...
 */
export class Crumb<Key extends string = string> {
    /**
     ...
     * crumb trail
     */
    constructor(data: any, state: State<Key>, link: string, crumblessLink: string, last: boolean);
}
 ...
 */
export class StateContext<Key extends string = string> {
    /**
...
export interface FluentNavigator<
    ...
    StateKey extends keyof NavigationInfo = string
>  {
    /**
     * Gets the current Url
     */
     ...
     */
    navigate<Key extends keyof NavigationInfo>(stateKey: Key, navigationData?: null | NavigationInfo[Key]): FluentNavigator<NavigationInfo, Key>;
    /**
     ...
     * @throws A mandatory route parameter has not been supplied a value
     */
    refresh(navigationData?: null | NavigationInfo[StateKey]): FluentNavigator<NavigationInfo, StateKey>;
}
...
> {
     ...
     */
    stateContext: StateContext<StateKey & string>;
    /**
     ...
     */
    states: { [Key in keyof NavigationInfo & string]: State<Key>; };
    /**
     ...
     */
    constructor(stateInfos?: StateInfo<keyof NavigationInfo & string>[] | StateNavigator<NavigationInfo, StateKey>, historyManager?: HistoryManager);
    /**
     * Configures the StateNavigator
     * @param stateInfos A collection of State Infos or another State Navigator
     * @param historyManager The manager of the browser Url
     */
    configure(stateInfos: StateInfo<keyof NavigationInfo & string>[] | StateNavigator<NavigationInfo, StateKey>, historyManager?: HistoryManager): void;
    /**
     ...
     * @throws A mandatory route parameter has not been supplied a value
     */
    navigate<Key extends keyof NavigationInfo>(stateKey: Key, navigationData?: null | NavigationInfo[Key], historyAction?: 'add' | 'replace' | 'none'): void;
    /**
     ...
     * NavigationData that cannot be converted to a String
     */
    getNavigationLink<Key extends keyof NavigationInfo>(stateKey: Key, navigationData?: null | NavigationInfo[Key]): string;
    /**
     ...
     * @throws A mandatory route parameter has not been supplied a value
     */
    refresh(navigationData?: null | NavigationInfo[StateKey], historyAction?: 'add' | 'replace' | 'none'): void;
    /**
     ...
     * @throws There is NavigationData that cannot be converted to a String
     */
    getRefreshLink(navigationData?: null | NavigationInfo[StateKey]): string;
    /**
     ...
     */
    fluent<B extends boolean>(withContext?: B): FluentNavigator<NavigationInfo, B extends true ? StateKey : string>
    /**
