...
export class StateNavigator {
    ...
    /**
     * Creates a StateContext
     * @param state The context State
     * @param data The context NavigationData
     * @param url The context url
     * @param asyncData The context data passed asynchronously
     * @param history The context value indicating whether browser history was used
     */
    ...
    /**
     * Gets a function that continues with the navigation
    ...
    /**
     * Notifies navigate event listeners and adds browser history
     * @param historyAction A value determining the effect on browser history
     */
    notify(historyAction: 'add' | 'replace' | 'none');
    /**
    ...
    /**
     * Clones the StateNavigator
     * @param historyManager The manager of the browser Url
     */
    clone(historyManager?: HistoryManager): StateNavigator;
    /**
