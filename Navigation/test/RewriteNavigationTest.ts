...
describe('Rewrite Navigation', () => {
    ...
    describe('Transition Rewrite Transition Back With Trail', () => {
        const test = navigate => {
            it('should populate href', () => {
                const stateNavigator = new StateNavigator([
                    { key: 's0', route: 'r0' },
    ...
    describe('Transition Rewrite Transition With Trail Rewrite Back With Trail', () => {
        const test = navigate => {
            it('should populate href', () => {
                const stateNavigator = new StateNavigator([
                    { key: 's0', route: 'r0' },
    ...
    describe('Transition Rewrite Transition With Trail Rewrite Transition Back With Trail', () => {
        const test = navigate => {
            it('should populate href', () => {
                const stateNavigator = new StateNavigator([
                    { key: 's0', route: 'r0' },
    ...
    describe('Transition Rewrite Transition With Trail Transition Back With Trail', () => {
        const test = navigate => {
            it('should populate href', () => {
                const stateNavigator = new StateNavigator([
                    { key: 's0', route: 'r0' },
    ...
    describe('Transition Transition With Trail Rewrite Transition Back With Trail', () => {
        const test = navigate => {
            it('should populate href', () => {
                const stateNavigator = new StateNavigator([
                    { key: 's0', route: 'r0' },
    ...
    describe('Transition Rewrite Transition With Trail Rewrite Transition Back With Trail Rewrite With Trail', () => {
        const test = navigate => {
            it('should populate href', () => {
                const stateNavigator = new StateNavigator([
                    { key: 's0', route: 'r0' },
    ...
    describe('Transition Rewrite Hash Transition With Trail Rewrite Hash Transition Back With Trail Rewrite With Trail Hash', () => {
        const test = navigate => {
            it('should populate href', () => {
                const stateNavigator = new StateNavigator([
                    { key: 's0', route: 'r0' },
    ...
    describe('Crumb Rewrite Custom Trail', () => {
        const test = navigate => {
            it('should populate href', () => {
                const stateNavigator = new StateNavigator([
                    { key: 's0', route: 'r0' },
